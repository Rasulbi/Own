...
Market-wise Comparison – Compare prices across different markets to choose the best selling option.

Weather-Aware Predictions – Factor in weather conditions to improve prediction accuracy.
...
Frontend: HTML, CSS, Chart.js (for interactive visual charts)
...
Machine Learning models analyze past patterns to predict future prices.

Predictions are displayed through easy-to-read charts on the frontend.
...
Helps farmers maximize profits and reduce losses.

Promotes smart agriculture through AI-based insights.
...
Voice-based support in local languages for better accessibility.
...
Configure MySQL database and load historical crop and weather data.

Run the Python backend to start predictions.

Open the frontend in a browser to view interactive price charts.

Conclusion

This project leverages AI to transform agriculture into a smart, data-driven, and profitable system. By providing farmers with accurate price predictions and market insights, it helps them sell at the right time and maximize earnings.
